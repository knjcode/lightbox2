...
(function() {
  ...
  Lightbox = (function() {
    ...
    Lightbox.prototype.enable = function() {
      return $('body').on('click', 'a[rel^=lightbox], area[rel^=lightbox], a[data-lightbox], area[data-lightbox]', (function(_this) {
        return function(e) {
    ...
    Lightbox.prototype.build = function() {
      ...
      this.$overlay.hide().on('click', (function(_this) {
        return function() {
          _this.end();
          return false;
        };
      })(this));
      this.$lightbox.hide().on('click', (function(_this) {
        return function(e) {
      ...
      this.$outerContainer.on('click', (function(_this) {
        return function(e) {
          if ($(e.target).attr('id') === 'lightbox') {
            _this.end();
          }
      ...
      this.$lightbox.find('.lb-prev').on('click', (function(_this) {
        return function() {
      ...
      this.$lightbox.find('.lb-next').on('click', (function(_this) {
        return function() {
      ...
      return this.$lightbox.find('.lb-loader, .lb-close').on('click', (function(_this) {
        return function() {
          _this.end();
          return false;
        };
    ...
    Lightbox.prototype.updateDetails = function() {
      ...
      this.$lightbox.find('.lb-dataContainer').fadeIn(this.resizeDuration, (function(_this) {
        return function() {
